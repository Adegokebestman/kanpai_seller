...
<section className="justify-center flex  dark:text-gray-100">
	<form novalidate="" className=" w-full max-w-xl pl-20 pr-20 mx-auto space-y-6 dark:bg-gray-900 ng-untouched ng-pristine ng-valid">
		<div>
			...
			<input id="firstname" type="text"  required="" className="block w-full p-2   border-[#AF501A] rounded focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-violet-400 dark:bg-gray-800"
				 value={FormData.firstname} onChange={(event) => setFormData({...FormData, firstname: event.target.value})}
			/>
		</div>

		<div>
			<label for="lastname" className="block mb-1 ml-1">Last Name</label>
			<input id="lastname" type="text" required="" className="block w-full p-2   border-[#AF501A] rounded focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-violet-400 dark:bg-gray-800"
		...
		<div>
			...
			<input id="email" type="email"  required="" className="block w-full p-2  border-[#AF501A]  rounded focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-violet-400 dark:bg-gray-800"
		...
		<div>
			...
			<input id="phone" type="tel"  required="" className="block w-full p-2  border-[#AF501A]  rounded focus:outline-none focus:ring focus:ring-opacity-25 focus:ring-violet-400 dark:bg-gray-800"
